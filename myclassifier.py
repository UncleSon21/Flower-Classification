...
filt1= tf.keras.layers.Flatten()(pool4)

dn1 = tf.keras.layers.Dense(units=512, activation='relu')(filt1)
dn2 = tf.keras.layers.Dense(units=5, activation='softmax')(dn1)

model = tf.keras.Model(input_layer, dn2)
